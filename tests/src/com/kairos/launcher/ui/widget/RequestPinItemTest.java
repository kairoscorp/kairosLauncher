...
import com.kairos.launcher.MainThreadExecutor;
...
import com.kairos.launcher.testcomponent.AppWidgetNoConfig;
import com.kairos.launcher.testcomponent.AppWidgetWithConfig;
import com.kairos.launcher.testcomponent.RequestPinItemActivity;
import com.kairos.launcher.ui.LauncherInstrumentationTestCase;
import com.kairos.launcher.util.Condition;
import com.kairos.launcher.util.SimpleActivityMonitor;
...
public class RequestPinItemTest  extends LauncherInstrumentationTestCase {
    ...
    private void runTest(String activityMethod, boolean isWidget, ItemOperator itemMatcher,
        ...
        mDevice.wait(Until.findObject(By.text(mTargetContext.getString(
                com.kairos.launcher.R.string.place_automatically).toUpperCase())), DEFAULT_UI_TIMEOUT).click();
