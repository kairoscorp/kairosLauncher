...
public class ShortcutsLaunchTest extends LauncherInstrumentationTestCase {
    ...
    private void performTest() throws Exception {
        ...
        UiObject2 deepShortcutsContainer = findViewById(com.kairos.launcher.R.id.deep_shortcuts_container);
        ...
        UiObject2 shortcut = deepShortcutsContainer.getChildren().get(0)
                .findObject(getSelectorForId(com.kairos.launcher.R.id.bubble_text));
        shortcut.click();
