...
public class AppDiscoveryItemView extends RelativeLayout {
    ...
    protected void onFinishInflate() {
        ...
        this.mImage = (ImageView) findViewById(com.kairos.launcher.R.id.image);
        this.mTitle = (TextView) findViewById(com.kairos.launcher.R.id.title);
        this.mRatingText = (TextView) findViewById(com.kairos.launcher.R.id.rating);
        this.mRatingView = (RatingView) findViewById(com.kairos.launcher.R.id.rating_view);
        this.mPrice = (TextView) findViewById(com.kairos.launcher.R.id.price);
        this.mReviewCount = (TextView) findViewById(com.kairos.launcher.R.id.review_count);
    }
