...
import com.kairos.launcher.FocusHelper.PagedFolderKeyEventListener;
...
public class FolderPagedView extends PagedView {
    ...
    public void setFolder(Folder folder) {
        ...
        mPageIndicator = (PageIndicator) folder.findViewById(com.kairos.launcher.R.id.folder_page_indicator);
    ...
    public View createNewView(ShortcutInfo item) {
        final BubbleTextView textView = (BubbleTextView) mInflater.inflate(
                com.kairos.launcher.R.layout.folder_application, null, false);
    ...
    private CellLayout createAndAddNewPage() {
        ...
        CellLayout page = (CellLayout) mInflater.inflate(com.kairos.launcher.R.layout.folder_page, this, false);
    ...
    public String getAccessibilityDescription() {
        return getContext().getString(com.kairos.launcher.R.string.folder_opened, mGridCountX, mGridCountY);
    }
