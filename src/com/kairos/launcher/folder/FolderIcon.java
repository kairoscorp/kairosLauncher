...
import com.kairos.launcher.CheckLongPressHelper;
import com.kairos.launcher.DeviceProfile;
import com.kairos.launcher.FastBitmapDrawable;
...
import com.kairos.launcher.SimpleOnStylusPressListener;
import com.kairos.launcher.StylusEventHelper;
import com.kairos.launcher.Utilities;
import com.kairos.launcher.Workspace;
import com.kairos.launcher.badge.BadgeRenderer;
...
public class FolderIcon extends FrameLayout implements FolderInfo.FolderListener {
    ...
    public static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        icon.mFolderName = (BubbleTextView) icon.findViewById(com.kairos.launcher.R.id.folder_icon_name);
        ...
        icon.setContentDescription(launcher.getString(com.kairos.launcher.R.string.folder_name_format, folderInfo.title));
    ...
    public void onTitleChanged(CharSequence title) {
        ...
        setContentDescription(getContext().getString(com.kairos.launcher.R.string.folder_name_format, title));
    }
    ...
    public void shrinkAndFadeIn(boolean animate) {
        ...
        oa.setDuration(getResources().getInteger(com.kairos.launcher.R.integer.config_folderExpandDuration));
