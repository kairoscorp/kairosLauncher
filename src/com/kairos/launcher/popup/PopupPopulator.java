...
import com.kairos.launcher.notification.NotificationInfo;
...
public class PopupPopulator {
    ...
    public enum Item {
        SHORTCUT(com.kairos.launcher.R.layout.deep_shortcut, true),
        NOTIFICATION(com.kairos.launcher.R.layout.notification, false),
        SYSTEM_SHORTCUT(com.kairos.launcher.R.layout.system_shortcut, true),
        SYSTEM_SHORTCUT_ICON(com.kairos.launcher.R.layout.system_shortcut_icon_only, true);
