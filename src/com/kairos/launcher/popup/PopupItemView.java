...
public abstract class PopupItemView extends FrameLayout
    ...
    protected void onFinishInflate() {
        ...
        mIconView = findViewById(com.kairos.launcher.R.id.popup_item_icon);
    }
    ...
    public Animator createOpenAnimation(boolean isContainerAboveIcon, boolean pivotLeft) {
        ...
        int arrowCenter = getResources().getDimensionPixelSize(pivotLeft ^ mIsRtl ?
                com.kairos.launcher.R.dimen.popup_arrow_horizontal_center_start:
                com.kairos.launcher.R.dimen.popup_arrow_horizontal_center_end);
    ...
    public Point getIconCenter() {
        ...
        sTempPoint.x = getResources().getDimensionPixelSize(com.kairos.launcher.R.dimen.bg_popup_item_height) / 2;
    ...
    protected float getBackgroundRadius() {
        return getResources().getDimensionPixelSize(com.kairos.launcher.R.dimen.bg_round_rect_radius);
    }
