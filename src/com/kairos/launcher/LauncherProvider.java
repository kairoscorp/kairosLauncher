...
import com.kairos.launcher.dynamicui.ExtractionUtils;
import com.kairos.launcher.graphics.IconShapeOverride;
import com.kairos.launcher.logging.FileLog;
import com.kairos.launcher.provider.LauncherDbUtils;
import com.kairos.launcher.provider.RestoreDbTask;
import com.kairos.launcher.util.ManagedProfileHeuristic;
import com.kairos.launcher.util.NoLocaleSqliteContext;
...
public class LauncherProvider extends ContentProvider {
    ...
    private boolean initializeExternalAdd(ContentValues values) {
        ...
        try {
            ...
            mOpenHelper.checkId(LauncherSettings.WorkspaceScreens.TABLE_NAME, valuesInserted);
            return true;
        } catch (Exception e) {
            return false;
        } finally {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        if (Binder.getCallingPid() != Process.myPid()
                && LauncherSettings.Favorites.TABLE_NAME.equalsIgnoreCase(args.table)) {
    ...
    private ArrayList<Long> deleteEmptyFolders() {
        ...
        try {
            ...
            Cursor c = db.query(LauncherSettings.Favorites.TABLE_NAME,
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper implements AutoInstallsLayout.LayoutParserCallback {
        ...
        private void removeOrphanedItems(SQLiteDatabase db) {
            ...
            //   AND container = -100"
            String removeOrphanedDesktopItems = "DELETE FROM " + LauncherSettings.Favorites.TABLE_NAME +
                    " WHERE " +
                    LauncherSettings.Favorites.SCREEN + " NOT IN (SELECT " +
                    LauncherSettings.WorkspaceScreens._ID + " FROM " + LauncherSettings.WorkspaceScreens.TABLE_NAME + ")" +
                    " AND " +
            ...
            String removeOrphanedFolderItems = "DELETE FROM " + LauncherSettings.Favorites.TABLE_NAME +
                    " WHERE " +
                    LauncherSettings.Favorites.CONTAINER + " <> " +
                    LauncherSettings.Favorites.CONTAINER_DESKTOP +
                    " AND "
                    ...
                    LauncherSettings.Favorites._ID + " FROM " + LauncherSettings.Favorites.TABLE_NAME +
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            switch (oldVersion) {
                ...
                case 15: {
                    if (!addIntegerColumn(db, LauncherSettings.Favorites.RESTORED, 0)) {
                        // Old version remains, which means we wipe old data
                        break;
                    }
                }
                ...
                case 22: {
                    if (!addIntegerColumn(db, LauncherSettings.Favorites.OPTIONS, 0)) {
                        // Old version remains, which means we wipe old data
                        break;
                    }
                }
        ...
        public void createEmptyDB(SQLiteDatabase db) {
            db.beginTransaction();
            try {
                db.execSQL("DROP TABLE IF EXISTS " + LauncherSettings.Favorites.TABLE_NAME);
                db.execSQL("DROP TABLE IF EXISTS " + LauncherSettings.WorkspaceScreens.TABLE_NAME);
                onCreate(db);
                db.setTransactionSuccessful();
            } finally {
                db.endTransaction();
        ...
        public void removeGhostWidgets(SQLiteDatabase db) {
            ...
            try {
                Cursor c = db.query(LauncherSettings.Favorites.TABLE_NAME,
                        ...
                        "itemType=" + LauncherSettings.Favorites.ITEM_TYPE_APPWIDGET, null, null, null, null);
        ...
        /**
         * Replaces all shortcuts of type {@link LauncherSettings.Favorites#ITEM_TYPE_SHORTCUT} which have a valid
         * launcher activity target with {@link LauncherSettings.Favorites#ITEM_TYPE_APPLICATION}.
         */
        @Thunk void convertShortcutsToLauncherActivities(SQLiteDatabase db) {
            ...
            try {
                ...
                c = db.query(LauncherSettings.Favorites.TABLE_NAME, new String[] {
                        LauncherSettings.Favorites._ID,
                        LauncherSettings.Favorites.INTENT,
                    }, "itemType=" + LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT + " AND profileId=" + userSerial,
                    null, null, null, null);
        ...
        public boolean recreateWorkspaceTable(SQLiteDatabase db) {
            db.beginTransaction();
            try {
                Cursor c = db.query(LauncherSettings.WorkspaceScreens.TABLE_NAME,
                ...
                for (int i = 0; i < total; i++) {
                    ...
                    addModifiedTime(values);
                    db.insertOrThrow(LauncherSettings.WorkspaceScreens.TABLE_NAME, null, values);
                }
                db.setTransactionSuccessful();
                mMaxScreenId = maxId;
            } catch (SQLException ex) {
        ...
        public long insertAndCheck(SQLiteDatabase db, ContentValues values) {
            return dbInsertAndCheck(this, db, LauncherSettings.Favorites.TABLE_NAME, null, values);
        }
