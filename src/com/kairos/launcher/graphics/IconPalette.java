...
public class IconPalette {
    ...
    public static @Nullable IconPalette getBadgePalette(Resources resources) {
        int badgeColor = resources.getColor(com.kairos.launcher.R.color.badge_color);
    ...
    public static @NonNull IconPalette getFolderBadgePalette(Resources resources) {
        if (sFolderBadgePalette == null) {
            int badgeColor = resources.getColor(com.kairos.launcher.R.color.folder_badge_color);
    ...
    private static int resolveColor(Context context, int color) {
        if (color == Notification.COLOR_DEFAULT) {
            return context.getColor(com.kairos.launcher.R.color.notification_icon_default_color);
        }
        return color;
    }
