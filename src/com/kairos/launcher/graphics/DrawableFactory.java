...
package com.kairos.launcher.graphics;
...
import com.kairos.launcher.allapps.AllAppsBackgroundDrawable;
...
public class DrawableFactory {
        ...
        synchronized (LOCK) {
            if (sInstance == null) {
                sInstance = Utilities.getOverrideObject(DrawableFactory.class,
                        context.getApplicationContext(), com.kairos.launcher.R.string.drawable_factory_class);
            }
            return sInstance;
        }
    }
    ...
    protected Path getPreloadProgressPath(Context context) {
        if (Utilities.isAtLeastO()) {
            try {
                ...
                Drawable icon = context.getDrawable(com.kairos.launcher.R.drawable.adaptive_icon_drawable_wrapper);
                icon.setBounds(0, 0,
    ...
    protected synchronized Bitmap getUserBadge(UserHandle user, Context context) {
        ...
        int badgeSize = res.getDimensionPixelSize(com.kairos.launcher.R.dimen.profile_badge_size);
