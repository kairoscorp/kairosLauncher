...
public class DeepShortcutTextView extends BubbleTextView {
    ...
    public DeepShortcutTextView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDragHandleWidth = resources.getDimensionPixelSize(com.kairos.launcher.R.dimen.popup_padding_end)
                + resources.getDimensionPixelSize(com.kairos.launcher.R.dimen.deep_shortcut_drag_handle_size)
                + resources.getDimensionPixelSize(com.kairos.launcher.R.dimen.deep_shortcut_drawable_padding) / 2;
    }
