...
import com.kairos.launcher.popup.PopupItemView;
import com.kairos.launcher.popup.PopupPopulator;
import com.kairos.launcher.popup.SystemShortcut;
...
public class ShortcutsItemView extends PopupItemView implements View.OnLongClickListener,
    ...
    protected void onFinishInflate() {
        ...
        mShortcutsLayout = findViewById(com.kairos.launcher.R.id.deep_shortcuts);
    }
        ...
        if (shortcutType == PopupPopulator.Item.SYSTEM_SHORTCUT_ICON) {
            ...
            if (mSystemShortcutIcons == null) {
                mSystemShortcutIcons = (LinearLayout) mLauncher.getLayoutInflater().inflate(
                        com.kairos.launcher.R.layout.system_shortcut_icons, mShortcutsLayout, false);
            ...
            if (mShortcutsLayout.getChildCount() > 0) {
                ...
                if (prevChild instanceof DeepShortcutView) {
                    prevChild.findViewById(com.kairos.launcher.R.id.divider).setVisibility(VISIBLE);
                }
            }
    ...
    public int getArrowColor(boolean isArrowAttachedToBottom) {
        return ContextCompat.getColor(getContext(),
                isArrowAttachedToBottom || mSystemShortcutIcons == null
                        ? com.kairos.launcher.R.color.popup_background_color
                        : com.kairos.launcher.R.color.popup_header_background_color);
    }
