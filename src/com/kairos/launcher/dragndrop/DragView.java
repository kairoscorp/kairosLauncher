...
public class DragView extends View {
    ...
    public DragView(Launcher launcher, Bitmap bitmap, int registrationX, int registrationY,
        ...
        mBlurSizeOutline = getResources().getDimensionPixelSize(com.kairos.launcher.R.dimen.blur_size_medium_outline);

        setElevation(getResources().getDimension(com.kairos.launcher.R.dimen.drag_elevation));
    }
