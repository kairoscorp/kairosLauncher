...
public class FlingToDeleteHelper {
    ...
    public FlingToDeleteHelper(Launcher launcher) {
        ...
        mFlingToDeleteThresholdVelocity = launcher.getResources()
                .getDimensionPixelSize(com.kairos.launcher.R.dimen.drag_flingToDeleteMinVelocity);
    }
    ...
    private PointF isFlingingToDelete() {
        if (mDropTarget == null) {
            mDropTarget = (ButtonDropTarget) mLauncher.findViewById(com.kairos.launcher.R.id.delete_target_text);
        }
