...
import com.kairos.launcher.DropTargetBar;
import com.kairos.launcher.ExtendedEditText;
import com.kairos.launcher.InsettableFrameLayout;
import com.kairos.launcher.Launcher;
import com.kairos.launcher.LauncherAppWidgetHostView;
import com.kairos.launcher.PinchToOverviewListener;
import com.kairos.launcher.ShortcutAndWidgetContainer;
...
import com.kairos.launcher.widget.WidgetsBottomSheet;
...
public class DragLayer extends InsettableFrameLayout {
    ...
    private void sendTapOutsideFolderAccessibilityEvent(boolean isEditingName) {
        int stringId = isEditingName ? com.kairos.launcher.R.string.folder_tap_to_rename : com.kairos.launcher.R.string.folder_tap_to_close;
    ...
    public void setInsets(Rect insets) {
        ...
        setBackgroundResource(insets.top == 0 ? 0 : com.kairos.launcher.R.drawable.workspace_bg);
    }
    ...
    public void addResizeFrame(LauncherAppWidgetHostView widget, CellLayout cellLayout) {
        ...
        mCurrentResizeFrame = (AppWidgetResizeFrame) LayoutInflater.from(mLauncher)
                .inflate(com.kairos.launcher.R.layout.app_widget_resize_frame, this, false);
    ...
    public void animateView(final DragView view, final Rect from, final Rect to,
        ...
        final float maxDist = (float) res.getInteger(com.kairos.launcher.R.integer.config_dropAnimMaxDist);

        // If duration < 0, this is a cue to compute the duration based on the distance
        if (duration < 0) {
            duration = res.getInteger(com.kairos.launcher.R.integer.config_dropAnimMaxDuration);
            if (dist < maxDist) {
                duration *= mCubicEaseOutInterpolator.getInterpolation(dist / maxDist);
            }
            duration = Math.max(duration, res.getInteger(com.kairos.launcher.R.integer.config_dropAnimMinDuration));
        }
