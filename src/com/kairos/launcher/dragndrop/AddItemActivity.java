...
import com.kairos.launcher.BaseActivity;
import com.kairos.launcher.InstallShortcutReceiver;
import com.kairos.launcher.InvariantDeviceProfile;
...
import com.kairos.launcher.widget.WidgetImageView;
...
public class AddItemActivity extends BaseActivity implements OnLongClickListener, OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.kairos.launcher.R.layout.add_item_confirmation_activity);
        mWidgetCell = (LivePreviewWidgetCell) findViewById(com.kairos.launcher.R.id.widget_cell);
        ...
        if (savedInstanceState == null) {
            logCommand(LauncherLogProto.Action.Command.ENTRY);
        }
    }
    ...
    public boolean onLongClick(View view) {
        ...
        if (!getResources().getBoolean(com.kairos.launcher.R.bool.allow_rotation) &&
    ...
    public void onCancelClick(View v) {
        logCommand(LauncherLogProto.Action.Command.CANCEL);
        finish();
    }
    ...
    public void onPlaceAutomaticallyClick(View v) {
        if (mRequest.getRequestType() == PinItemRequestCompat.REQUEST_TYPE_SHORTCUT) {
            ...
            logCommand(LauncherLogProto.Action.Command.CONFIRM);
            mRequest.accept();
            finish();
            return;
        }
    ...
    public void onBackPressed() {
        logCommand(LauncherLogProto.Action.Command.BACK);
        super.onBackPressed();
    }
    ...
    private void logCommand(int command) {
        getUserEventDispatcher().dispatchUserEvent(LoggerUtils.newLauncherEvent(
                LoggerUtils.newCommandAction(command),
                LoggerUtils.newItemTarget(mWidgetCell.getWidgetView()),
                LoggerUtils.newContainerTarget(LauncherLogProto.ContainerType.PINITEM)), null);
    }
}
