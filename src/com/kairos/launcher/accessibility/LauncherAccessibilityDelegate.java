...
import com.kairos.launcher.AppWidgetResizeFrame;
...
public class LauncherAccessibilityDelegate extends AccessibilityDelegate implements DragController.DragListener {
    ...
    protected static final int REMOVE = com.kairos.launcher.R.id.action_remove;
    protected static final int INFO = com.kairos.launcher.R.id.action_info;
    protected static final int UNINSTALL = com.kairos.launcher.R.id.action_uninstall;
    protected static final int ADD_TO_WORKSPACE = com.kairos.launcher.R.id.action_add_to_workspace;
    protected static final int MOVE = com.kairos.launcher.R.id.action_move;
    protected static final int MOVE_TO_WORKSPACE = com.kairos.launcher.R.id.action_move_to_workspace;
    protected static final int RESIZE = com.kairos.launcher.R.id.action_resize;
    public static final int DEEP_SHORTCUTS = com.kairos.launcher.R.id.action_deep_shortcuts;
    ...
    public LauncherAccessibilityDelegate(Launcher launcher) {
        ...
        mActions.put(REMOVE, new AccessibilityAction(REMOVE,
                launcher.getText(com.kairos.launcher.R.string.remove_drop_target_label)));
        mActions.put(INFO, new AccessibilityAction(INFO,
                launcher.getText(com.kairos.launcher.R.string.app_info_drop_target_label)));
        mActions.put(UNINSTALL, new AccessibilityAction(UNINSTALL,
                launcher.getText(com.kairos.launcher.R.string.uninstall_drop_target_label)));
        mActions.put(ADD_TO_WORKSPACE, new AccessibilityAction(ADD_TO_WORKSPACE,
                launcher.getText(com.kairos.launcher.R.string.action_add_to_workspace)));
        mActions.put(MOVE, new AccessibilityAction(MOVE,
                launcher.getText(com.kairos.launcher.R.string.action_move)));
        mActions.put(MOVE_TO_WORKSPACE, new AccessibilityAction(MOVE_TO_WORKSPACE,
                launcher.getText(com.kairos.launcher.R.string.action_move_to_workspace)));
        mActions.put(RESIZE, new AccessibilityAction(RESIZE,
                        launcher.getText(com.kairos.launcher.R.string.action_resize)));
        mActions.put(DEEP_SHORTCUTS, new AccessibilityAction(DEEP_SHORTCUTS,
                launcher.getText(com.kairos.launcher.R.string.action_deep_shortcut)));
    }
        ...
        if (action == REMOVE) {
            ...
            new Handler().post(new Runnable() {
                ...
                public void run() {
                    ...
                    itemList.add(item);
                    mLauncher.bindItems(itemList, 0, itemList.size(), true);
                    announceConfirmation(com.kairos.launcher.R.string.item_moved);
                }
            });
            ...
            new AlertDialog.Builder(mLauncher)
                .setTitle(com.kairos.launcher.R.string.action_resize)
    ...
    private ArrayList<Integer> getSupportedResizeActions(View host, LauncherAppWidgetInfo info) {
        ...
        if ((providerInfo.resizeMode & AppWidgetProviderInfo.RESIZE_HORIZONTAL) != 0) {
            if (layout.isRegionVacant(info.cellX + info.spanX, info.cellY, 1, info.spanY) ||
                ...
                actions.add(com.kairos.launcher.R.string.action_increase_width);
            }

            if (info.spanX > info.minSpanX && info.spanX > 1) {
                actions.add(com.kairos.launcher.R.string.action_decrease_width);
            }
        }
        ...
        if ((providerInfo.resizeMode & AppWidgetProviderInfo.RESIZE_VERTICAL) != 0) {
            if (layout.isRegionVacant(info.cellX, info.cellY + info.spanY, info.spanX, 1) ||
                ...
                actions.add(com.kairos.launcher.R.string.action_increase_height);
            }

            if (info.spanY > info.minSpanY && info.spanY > 1) {
                actions.add(com.kairos.launcher.R.string.action_decrease_height);
            }
        }
        return actions;
    }
    ...
    @Thunk void performResizeAction(int action, View host, LauncherAppWidgetInfo info) {
        ...
        if (action == com.kairos.launcher.R.string.action_increase_width) {
            ...
            lp.cellHSpan ++;
            info.spanX ++;
        } else if (action == com.kairos.launcher.R.string.action_decrease_width) {
            lp.cellHSpan --;
            info.spanX --;
        } else if (action == com.kairos.launcher.R.string.action_increase_height) {
            if (!layout.isRegionVacant(info.cellX, info.cellY + info.spanY, info.spanX, 1)) {
                lp.cellY --;
                info.cellY --;
            }
            lp.cellVSpan ++;
            info.spanY ++;
        } else if (action == com.kairos.launcher.R.string.action_decrease_height) {
            lp.cellVSpan --;
            info.spanY --;
        }
        ...
        announceConfirmation(mLauncher.getString(com.kairos.launcher.R.string.widget_resized, info.spanX, info.spanY));
    }
