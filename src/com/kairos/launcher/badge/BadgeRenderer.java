...
package com.kairos.launcher.badge;
...
public class BadgeRenderer {
    ...
    public BadgeRenderer(Context context, int iconSizePx) {
        ...
        mLargeIconDrawer = new IconDrawer(res.getDimensionPixelSize(com.kairos.launcher.R.dimen.badge_small_padding));
        mSmallIconDrawer = new IconDrawer(res.getDimensionPixelSize(com.kairos.launcher.R.dimen.badge_large_padding));
